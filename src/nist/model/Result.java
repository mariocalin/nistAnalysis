...
=======
	...
	public class CategoriesResult implements INistDataResult {
		...
		public String toString() {
			...
			int entriesSinCategoria = entries.stream().filter(ent -> !ent.hasCategory()).collect(Collectors.toList())
					.size();
			...
			sb.append("Vulnerabilidades sin categoria -> " + entriesSinCategoria + " : score "
					+ doubleToCommaString(noCatAvgScore));
		...
		public void toCSV(String namefile, boolean removeFileIfExists) throws IOException {
			...
			sb.append("others; " + entriesSinCategoria + "; " + doubleToCommaString(noCatAvgScore));
